...
const ARTIFACT_DIR = path.resolve('artifacts/playwright/cycle02-ux');
...
fs.writeFileSync(LOG_PATH, `Cycle02 UX validation start: ${new Date().toISOString()}\n`, 'utf8');
...
try {
  ...
  appendLog(`Cycle02 UX validation end: ${new Date().toISOString()}`);
}
