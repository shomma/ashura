...
const ARTIFACT_DIR = path.resolve('artifacts/playwright/cycle03-ux');
...
fs.writeFileSync(LOG_PATH, `Cycle03 UX validation start: ${new Date().toISOString()}\n`, 'utf8');
...
try {
  ...
  appendLog(`Cycle03 UX validation end: ${new Date().toISOString()}`);
}
